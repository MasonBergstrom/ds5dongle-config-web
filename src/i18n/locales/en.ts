export const en = {
  ...
  config: {
    ...
    help: {
      ...
      enableIdleUsb:
        "Experimental; requires Wake host on PS press. When the controller disconnects, the dongle briefly re-enumerates as a separate configuration and wake USB device. The virtual DualSense and its audio devices disappear, but this portal can still configure the dongle after the new identity is authorized. Each controller connect/disconnect causes about a 250 ms USB device replacement and may show application notifications; software that handles device removal poorly may need to be restarted. Windows also installs the idle HID device the first time. Leave this disabled if you experience USB, audio, game, or wake instability.",
      pollingRateMode:
